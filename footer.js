                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 col-lg-3 col-12 ft-2">
                            ...
                            <ul className={footerCSS.navItem}>
                                ...
                                <li className="nav-item">
                                <Link className="nav-link ps-0" to="/contactus">Contact</Link>
                                </li>
                                <li className="nav-item">
                        ...
                        <div className="col-md-6 col-lg-3 col-12 ft-3">
                            <h5>Contacts</h5>
                            <p>Address: Shop No. 2, 60, Sarkaripally, Bansberia, Hooghly 712502 West Bengal, India
                               Email: info@startnd.com
                               Email: support@startnd.com</p>
                        </div>
                    </div>
                </div>
            </div>
